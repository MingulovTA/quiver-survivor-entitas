...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Lifetime.LifetimeComponents.CurrentHealth currentHealth { get { return (Code.Gameplay.Features.Lifetime.LifetimeComponents.CurrentHealth)GetComponent(GameComponentsLookup.CurrentHealth); } }
    ...
    public GameEntity AddCurrentHealth(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Lifetime.LifetimeComponents.CurrentHealth)CreateComponent(index, typeof(Code.Gameplay.Features.Lifetime.LifetimeComponents.CurrentHealth));
